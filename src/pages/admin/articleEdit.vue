<template>
    <div class="edit_wrap">
      ...
      <div class="markdown">
        <mavon-editor :ishljs="true" v-model="content" />
      </div>
  ...
  export default {
    ...
    data() {
      return {
        ...
        'websocket','Vue','react','react-native','android',
        'node','mongo','CentOS','webpack','elementUI','Vant',
        'easyUI','ECharts','wx','Markdown','读书笔记','生活随感','其他']
      }
    },
