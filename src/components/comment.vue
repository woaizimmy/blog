<template>
  <el-card class="page">
      <div v-if="isSignIn===0" @click="signIn" class="signIn">登录留言</div>
      <div v-else class="part part_input">
        ...
        <div class="input_down">
          <el-button type="primary" @click="submit_new">提交</el-button>
        </div>
      </div>
            ...
            <div class="floor_r">
              <div class="comment">
                ...
                <div v-if="comment.open" class="comment_replay__bar">
                  ...
                  <div class="down">
                    <el-button type="" @click="setTextarea(index,false)">收起↑</el-button>
                    <el-button type="primary" @click="submit_reply(comment.id,comment.to_uid,comment.to_uname,textArea[index])">发表</el-button>
                  </div>
                </div>
              </div>
            </div>
